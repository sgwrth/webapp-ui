...
@Component({
  selector: 'app-profile-pic-upload-popup',
  templateUrl: './profile-pic-upload-popup.component.html',
  styleUrl: './profile-pic-upload-popup.component.css'
  })

export class ProfilePicUploadPopupComponent implements OnInit {
  ...
  constructor(
      ...
      private store: Store,
      public dialogRef: MatDialogRef<ProfilePicUploadPopupComponent>,
  ) {
  ...
  submitFile() {
    const upload$ = this.fileServ.postPicture(this.prepareFormData())
        .pipe(
            tap(
